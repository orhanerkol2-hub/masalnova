...
export const gameEditorial: Record<string, GameEditorial> = {
  'dino-buz-cicekleri': {
    overview: 'Dino Ateşi: Üç Dünya, aynı hareketi tekrarlamak yerine üç farklı beceriyi sırayla kullanan kısa bir macera oyunudur. Güneş Vadisi nişan almayı öğretir, Kristal Orman beş konumluk bir ışık sırasını hatırlatır, Volkan Tapınağı ise hareketli göstergede doğru anı yakalamayı ister. Pofi’nin ateşi her dünyada zarar vermek yerine çiçekleri, kristalleri ve dinozor yumurtalarını uyandırır. Her bölüm kendi arka planına, hedeflerine ve görev kuralına sahiptir; bu nedenle yeni dünyaya geçmek yalnızca renklerin değişmesi anlamına gelmez. Oyuncu önce serbestçe seçim yapar, sonra gördüğü sırayı uygular ve finalde sakin biçimde doğru anı bekler.',
    play: 'Hedefe dokun ve beyaz yolu kontrol et. İlk dünyada ÜFLE düğmesi seçili çiçeği açar. İkinci dünyada kristallerin parladığı sırayı izle ve onları aynı sırayla YAK. Finalde beyaz çizgi yeşil alana ulaştığında ISIT düğmesine bas. Üç ateş enerjisi bitse bile tamamlanan hedefler silinmez; kısa bir dinlenmeden sonra haklar yenilenir. Ekranın üstündeki görev kartı o dünyanın kuralını, yıldız sayacı ise tamamlanan hedefleri gösterir. Yanlış bir seçimden sonra aynı hedefi yeniden deneyebilir veya oklarla başka bir hedefe geçebilirsin.',
    tips: ['Kristal sırasını tek tek değil, yukarı–aşağı veya sağ–sol gibi küçük bir rota olarak hatırla. Parlayan konumları sessizce saymak da işini kolaylaştırabilir.', 'Volkan dünyasında düğmeye göstergenin yeşile gireceğini tahmin ederek dokun; tam ortayı beklemek zorunda değilsin. İlk hareketlerde göstergenin hızını gözlemle.', 'Ok tuşları hedef değiştirir, Enter veya boşluk ateşi kullanır ve R dünyayı yeniler. Dokunmatik ekranda ise hedefi seçtikten sonra büyük ateş düğmesine basman yeterlidir.'],
    parent: 'Oyun yaklaşık 6–7 yaş için okunabilir kısa yönergeler, görsel tekrar ve affedici denemeler sunar. Yanlış hamle enerji azaltır ama kazanılmış ilerlemeyi geri almaz. Böylece hafıza ve zamanlama gerçekten devreye girerken başarısızlık duygusu büyümez. Yetişkinler ilk kristal sırasını çocukla birlikte sesli tekrar edebilir, ardından çözümü söylemeden çocuğun kendi yöntemini denemesine alan bırakabilir. Oyun reklam, satın alma, sohbet, dış bağlantı veya kişisel veri toplama içermez; bölüm ilerlemesi yalnızca kullanılan cihazda saklanır.',
  },
  'ay-isigi-bahcesi': {
  ...
  'nasrettin-hoca-pizza': {
    overview: 'Nasrettin Hoca’nın Pizzahanesi, masalsı bir köy fırınında gelen siparişleri doğru malzemelerle hazırlamaya dayanan zaman yönetimi oyunudur. Her müşteri farklı bir pizza ister; oyuncu fişi okuyup malzemeleri seçer, pizzayı fırına verir ve yeni siparişe geçer. Domates, peynir, mantar ve diğer malzemeler görsel olarak ayrılırken sipariş kartı tamamlanması gereken tarifi açıkça gösterir. Doğru ve art arda tamamlanan siparişler kombo puanını büyütür. Nasrettin Hoca’nın kısa tepkileri, puan göstergesi ve süre çubuğu her teslimattan sonra sonucun neden başarılı ya da eksik olduğunu anlamaya yardımcı olur.',
    play: 'Önce müşteri fişindeki malzemeleri dikkatle incele. Malzemeye dokun veya onu hamurun üzerine sürükle; gerekenlerin tamamı yerleşince pizzayı fırına gönder. Seçtiğin malzemeler hamurun üzerinde görünür, bu yüzden teslim etmeden önce tarifle son bir karşılaştırma yapabilirsin. Yanlış eklenen bir malzemeyi temizleme düğmesiyle kaldırmak mümkündür. Sipariş süresi dolmadan doğru pizzayı teslim etmek puan ve zaman bonusu kazandırır. Bir sipariş bittiğinde yeni müşteri gelir ve tarif değişir; oyun böylece aynı pizzayı ezberlemek yerine dikkatini yeniden toplamanı ister.',
    tips: ['Malzemeleri seçmeden önce fişi bir kez baştan sona kontrol et. Önce kaç farklı malzeme istendiğini saymak eksik bırakma riskini azaltır.', 'Benzer görünen siparişlerde hamurun üzerindeki malzemeleri fişle soldan sağa karşılaştır. Emin değilsen fırına göndermeden önce temizleyip yeniden kurabilirsin.', 'Hızlanmadan önce doğruluğa odaklan; doğru seriler daha değerli kombo oluşturur. Klavyede 1–8 malzeme seçer, R pizzayı temizler, Enter veya boşluk siparişi teslim eder.'],
    parent: 'Oyun görsel eşleştirme, sıralı işlem ve süre içinde karar verme pratiği sunar. Küçük oyuncularda ilk siparişleri birlikte okumak, malzemelerin adlarını söylemek ve “Fişte olup pizzada olmayan ne kaldı?” diye sormak yeterlidir. Sonraki siparişlerde kontrolü çocuğa bırakmak bağımsız denemeye alan açar. Süre baskısı rahatsız ederse amaç yüksek puan değil, her tarifi doğru karşılaştırmak olarak belirlenebilir. Oyun gerçek para, satın alma, reklam, sohbet, kişisel veri girişi veya dış bağlantı içermez; en iyi puan yalnızca kullanılan cihazda saklanır.',
  },
};
